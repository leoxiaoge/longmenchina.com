	...
	<div class="w cle html5_w90">
		<div class="mdb_tab">
			...
			<div class="lists i1 fl">
				...
				<!-- <a href="erweima.php" class="fl" id="gzh">购买会员</a> -->
			</div>
			</a>
			<a href="/yearvip.php">
			<div class="lists i2 fl">
				...
				<!-- <div class="p">
				<? if($uid){ ?>
							    <a href="#" class="fr" id="gzh">购买会员</a>
							    <? }else{ ?>
							    <a href="login.php" class="fr">购买会员</a>
							    <? } ?>
							    </div> -->
...
<!-- <script>
			$(function() {
				var str = '';
				$('#gzh').click(function() {
					str += '<div class="ewm_box cle"><p class="cle">请扫描关注<span class="fr close" id="close" onclick="bigs()">×</span></p><div class="c"><img src="./uploadfile/upload/<?=$System_img3?>" ></div></div>';
					$('body').append(str);
				});
			})
			function bigs() {
...
<script>
			$(function() {
				var str = '';
				$('#gzh').click(function() {
					str += '<div class="ewm_box cle"><p class="cle">购买会员<span class="fr close" id="close" onclick="bigs()">×</span></p><div class="c"><img src="img/img76.jpg" ></div></div>';
					$('body').append(str);
				});
			})
			function bigs() {
...
<script>
			$(function() {
				var str = '';
				$('#g').click(function() {
					str += '<div class="ewm_box cle"><p class="cle">购买会员<span class="fr close" id="close" onclick="bigs()">×</span></p><div class="c"><img src="img/vip.jpg" ></div></div>';
					$('body').append(str);
				});
			})
			function bigs() {
		...
		<div class="but html5_w90 cle">
			<div class="er"><a href="erweima.php" class="fl" >欲购联系>></a></div>
			
			<!-- <? if($uid){ ?>
			<a href="vip.php" class="fr">加入会员</a>
			<? }else{ ?>
...
<div class="m17ss wow fadeInDown animated" data-wow-duration="1.5s" data-wow-delay="1s">
	...
	<img src="./uploadfile/upload/<?=get_zd_name("img1","news"," and id=70 ")?>" width="100%" />
</div>