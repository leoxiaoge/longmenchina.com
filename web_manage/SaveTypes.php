...
<script>
	$(function () {
		...
		InsertOrUpdate = 0, //0是添加，1是修改，默认为0，添加商品或者是修改商品。如果是添加商品需要将GoodsID手动改为0!如果是修改则传入正常的商品ID
		GoodsID = 0, //商品ID。来自商品表(Prodect)
...
<![CDATA[
self.parent.document.getElementById('txtPSupplierName').value = '0|1|规格1|101|ss1|11|22,';var _index = parent.layer.getFrameIndex(window.name); self.parent.layer.close(_index);  //]]>
</script>
