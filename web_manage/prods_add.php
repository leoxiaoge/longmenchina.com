		...
		<div id="tab1" class="tabson">
			...
			<ul class="forminfo">
				...
				<form action="" method="post" name="formlist" enctype="multipart/form-data"  onSubmit="return prod_check(this);">
					...
					<li><label>商品名称<b>*</b></label><input name="info[title]" type="text" class="dfinput" value=""  style="width:518px;"/></li>
					
					<li><label>商品货号<b>*</b></label><input name="info[ftitle]" type="text" class="dfinput" value="" style="width:518px;"/></li>
					
					<li><label>商品尺码<b>*</b></label><input name="info[code]" type="text" class="dfinput" value="" style="width:518px;"/></li>
					
					<li><label>本站售价</label><input name="info[price]" type="text" class="dfinput" value="0" style="width:80px;"/></li>
