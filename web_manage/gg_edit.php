		...
		<div id="tab1" class="tabson">
			...
			<ul class="forminfo">
				...
				<form action="" method="post" name="formlist" enctype="multipart/form-data" onSubmit="return check_ad(this);">
					...
					<li><label>副标题<b>*</b></label><input name="info[ftitle]" type="text" class="dfinput" value="<?=$row['ftitle']?>"/></li>

					<? if($ty==32){ ?>
					<li><label>价格<b>*</b></label><input name="info[price]" type="text" class="dfinput" value="<?=$row['price']?>"/></li>
