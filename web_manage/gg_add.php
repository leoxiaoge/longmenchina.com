		...
		<div id="tab1" class="tabson">
			...
			<ul class="forminfo">
				<form action="" method="post" name="formlist" enctype="multipart/form-data"  onSubmit="return news_check(this);">
					...
					<li><label>副标题<b>*</b></label><input name="info[ftitle]" type="text" class="dfinput" value=""/></li>

					<? if($ty==32){ ?>
					<li><label>价格<b>*</b></label><input name="info[price]" type="text" class="dfinput" value=""/></li>
					...
					<li><label>广告图片<b>*</b></label><input name="img<?=$i?>" type="file" id="img<?=$i?>"> <font color="#FF0000">图片大小:<?=$System_Picsize?>K内<? if($arrValue[$i-1]){?>,图片尺寸：<?=$arrValue[$i-1]?>px<? }?></font></li>
					<? }?>
