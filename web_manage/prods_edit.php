	...
	<div id="usual1" class="usual"> 
		...
		<div id="tab1" class="tabson">
			...
			<form action="" method="post" name="formlist" enctype="multipart/form-data" onSubmit="return prod_check(this);">
				...
				<li><label>商品名称<b>*</b></label><input name="info[title]" type="text" class="dfinput" value="<?=$row['title']?>"  style="width:518px;"/></li>
				
				<li><label>商品货号<b>*</b></label><input name="info[ftitle]" type="text" class="dfinput" value="<?=$row['ftitle']?>" style="width:518px;"/></li>
				
				<li><label>库存<b>*</b></label><input name="info[inventory]" type="text" class="dfinput" value="<?=$row['inventory']?>" style="width:218px;"/></li>
				
				<li><label>本站售价</label><input name="info[price]" type="text" class="dfinput" value="<?=$row['price']?>" style="width:80px;"/>站外售价<input name="info[mprice]" type="text" class="dfinput" value="<?=$row['mprice']?>" style="width:80px;"/></li>
				...
				<li><label>产品详情<b>*</b></label><?=get_kindeditor(new_stripslashes(new_html_entity_decode($row['content'])),"content")?></li>
				...
				?> <font color="#FF0000">图片大小:<?=$System_Picsize?>K内,图片尺寸：550*550px</font></li>
				<? }?>
